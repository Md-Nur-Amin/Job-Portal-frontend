            ...
            <div className="card bg-base-100 w-full max-w-md shadow-2xl p-8 my-10">
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                    ...
                    <div>
                        ...
                        <label htmlFor="terms"> I agree to the <Link to="/terms" className="link link-hover">terms and conditions</Link></label>
                    </div>
                ...
                <div className="my-2">
                    <p className="text-center">
                        Already have an account? <Link to="/login" className="underline text-blue-500"> Log In </Link>
                    </p>
                </div>
            </div>
        </div>
